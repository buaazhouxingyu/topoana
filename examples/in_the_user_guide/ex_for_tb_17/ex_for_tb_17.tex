...
\tablecaption{Signal inclusive decay branches.}
\tableheaderP{rowNo & \thead{signal inclusive decay branch} & \topoTags{iSigIncDcyBr & }nCase & nCCase \\}

% \rn = 1
\rn & $ \bar{B}^{0} \rightarrow D^{*+}  + anything $ & \topoTags{0 & }41751 & 41751 \EOL

% \rn = 2
\rn & $ B^{0} \rightarrow K_{S}^{0}  + anything $ & \topoTags{1 & }153 & 41904 \\ \hline
