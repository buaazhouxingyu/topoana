...
\tablecaption{Signal cascade decay branches.}
\tableheaderP{rowNo & \thead{signal cascade decay branch} & \topoTags{iSigCascDcyBr & }nCase & nCCase \\}
...
$ } & \topoTags{0 & }1119 & 1119 \EOL

% \rn = 2
\rn & \makecell[l]{ $ 
B^{0} \rightarrow D^{*-} D_{s}^{*+} ,
D^{*-} \rightarrow \pi^{-} \bar{D}^{0} 
$ } & \topoTags{1 & }1180 & 2299 \\ \hline
