...
void topoana::getRslt()
{
  ...
  float Npsf,Pidf[NpsMax],Midxf[NpsMax];
  ...
  float Tagrecsf_compDcyBrP[sAtdbPid];
  ...
  float Tagrecsf_compCascDcyBrP[sAtcdbPid];
  ...
  float Tagrecsf_compDcyFStP[sAtdfstPid];
  ...
  float Tagrecsf_compProdBrP[sAtpbPid];
  ...
  float Tagrecsf_sigDcyBr[sSigDcyBr];
  ...
  float Tagrecsf_sigIncDcyBr[sSigIncDcyBr];
  ...
  float Tagrecsf_sigCascDcyBr[sSigCascDcyBr];
  ...
  float Tagrecsf_sigIncCascDcyBr[sSigIncCascDcyBr];
  ...
  float Tagrecsf_sigIRADcyBr[sSigIRADcyBr];
  ...
  float Tagrecsf_sigIncOrIRACascDcyBr[sSigIncOrIRACascDcyBr];
  ...
  if(m_vPid_compDcyBrP.size()>0) setBranchAddress(m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, chn, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP);

  if(m_vPid_compCascDcyBrP.size()>0) setBranchAddress(m_vTypeOfTagRec_compCascDcyBrP, m_vTBrNmOfTagRec_compCascDcyBrP, m_vTBrNmOfNRec_compCascDcyBrP, chn, Tagrecsd_compCascDcyBrP, Tagrecsf_compCascDcyBrP, Tagrecsi_compCascDcyBrP, Tagreca_compCascDcyBrP, Nrec_compCascDcyBrP);

  if(m_vPid_compDcyFStP.size()>0) setBranchAddress(m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, chn, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP);

  if(m_vPid_compProdBrP.size()>0) setBranchAddress(m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, chn, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP);

  if(m_vPid_compMP.size()>0) setBranchAddress(m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, chn, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP);

  if(m_vPid_sigP.size()>0) setBranchAddress(m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, chn, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP);

  if(m_vSigDcyBr.size()>0) setBranchAddress(m_vTypeOfTagRec_sigDcyBr, m_vTBrNmOfTagRec_sigDcyBr, m_vTBrNmOfNRec_sigDcyBr, chn, Tagrecsd_sigDcyBr, Tagrecsf_sigDcyBr, Tagrecsi_sigDcyBr, Tagreca_sigDcyBr, Nrec_sigDcyBr);

  if(m_vSigIncDcyBr.size()>0) setBranchAddress(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, chn, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr);

  if(m_vSigCascDcyBr.size()>0) setBranchAddress(m_vTypeOfTagRec_sigCascDcyBr, m_vTBrNmOfTagRec_sigCascDcyBr, m_vTBrNmOfNRec_sigCascDcyBr, chn, Tagrecsd_sigCascDcyBr, Tagrecsf_sigCascDcyBr, Tagrecsi_sigCascDcyBr, Tagreca_sigCascDcyBr, Nrec_sigCascDcyBr);

  if(m_vSigIncCascDcyBr.size()>0) setBranchAddress(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, chn, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr);

  if(m_vSigIRADcyBr.size()>0) setBranchAddress(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, chn, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr);

  if(m_vSigIncOrIRACascDcyBr.size()>0) setBranchAddress(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, chn, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr);
      ...
      for(unsigned int i=0;i<nEtrToBePrcsd;i++)
        {
          ...
          if(m_strgTpOfRawIptTopoDat=="MSF")
            {
              Npsd=Npsf;
              for(unsigned int i=0;i<NpsMax;i++)
                {
                  Pidd[i]=Pidf[i];
                  Midxd[i]=Midxf[i];
                }
          ...
          if(m_vSigIncOrIRACascDcyBr.size()>0)
            {
              if(m_vPid_compDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP, "% Component analysis --- decay branches of particles");
              ...
              if(m_vPid_compDcyFStP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP, "% Component analysis --- decay final states of particles");
              if(m_vPid_compProdBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles");
              if(m_vPid_compMP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles");
              if(m_vPid_sigP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles");
              if(m_vSigDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_sigDcyBr, m_vTBrNmOfTagRec_sigDcyBr, m_vTBrNmOfNRec_sigDcyBr, Tagrecsd_sigDcyBr, Tagrecsf_sigDcyBr, Tagrecsi_sigDcyBr, Tagreca_sigDcyBr, Nrec_sigDcyBr, "% Signal identification --- decay branches");
              if(m_vSigIncDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches");
              if(m_vSigCascDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_sigCascDcyBr, m_vTBrNmOfTagRec_sigCascDcyBr, m_vTBrNmOfNRec_sigCascDcyBr, Tagrecsd_sigCascDcyBr, Tagrecsf_sigCascDcyBr, Tagrecsi_sigCascDcyBr, Tagreca_sigCascDcyBr, Nrec_sigCascDcyBr, "% Signal identification --- cascade decay branches");
              if(m_vSigIncCascDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches");
              if(m_vSigIRADcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfTagRec_sigIncOrIRACascDcyBr, m_vTBrNmOfNRec_sigIncOrIRACascDcyBr, Tagrecsd_sigIncOrIRACascDcyBr, Tagrecsf_sigIncOrIRACascDcyBr, Tagrecsi_sigIncOrIRACascDcyBr, Tagreca_sigIncOrIRACascDcyBr, Nrec_sigIncOrIRACascDcyBr, "% Signal identification --- inclusive or intermediate-resonance-allowed cascade decay branches", m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches");
            }
          else if(m_vSigIRADcyBr.size()>0)
            {
              if(m_vPid_compDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP, "% Component analysis --- decay branches of particles");
              if(m_vPid_compCascDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_compCascDcyBrP, m_vTBrNmOfTagRec_compCascDcyBrP, m_vTBrNmOfNRec_compCascDcyBrP, Tagrecsd_compCascDcyBrP, Tagrecsf_compCascDcyBrP, Tagrecsi_compCascDcyBrP, Tagreca_compCascDcyBrP, Nrec_compCascDcyBrP, "% Component analysis --- cascade decay branches of particles");
              if(m_vPid_compDcyFStP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP, "% Component analysis --- decay final states of particles");
              if(m_vPid_compProdBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles");
              if(m_vPid_compMP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles");
              if(m_vPid_sigP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles");
              if(m_vSigDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_sigDcyBr, m_vTBrNmOfTagRec_sigDcyBr, m_vTBrNmOfNRec_sigDcyBr, Tagrecsd_sigDcyBr, Tagrecsf_sigDcyBr, Tagrecsi_sigDcyBr, Tagreca_sigDcyBr, Nrec_sigDcyBr, "% Signal identification --- decay branches");
              if(m_vSigIncDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches");
              if(m_vSigCascDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_sigCascDcyBr, m_vTBrNmOfTagRec_sigCascDcyBr, m_vTBrNmOfNRec_sigCascDcyBr, Tagrecsd_sigCascDcyBr, Tagrecsf_sigCascDcyBr, Tagrecsi_sigCascDcyBr, Tagreca_sigCascDcyBr, Nrec_sigCascDcyBr, "% Signal identification --- cascade decay branches");
              if(m_vSigIncCascDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIRADcyBr, m_vTBrNmOfTagRec_sigIRADcyBr, m_vTBrNmOfNRec_sigIRADcyBr, Tagrecsd_sigIRADcyBr, Tagrecsf_sigIRADcyBr, Tagrecsi_sigIRADcyBr, Tagreca_sigIRADcyBr, Nrec_sigIRADcyBr, "% Signal identification --- intermediate-resonance-allowed decay branches", m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches");
            }
          else if(m_vSigIncCascDcyBr.size()>0)
            {
              if(m_vPid_compDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP, "% Component analysis --- decay branches of particles");
              if(m_vPid_compCascDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_compCascDcyBrP, m_vTBrNmOfTagRec_compCascDcyBrP, m_vTBrNmOfNRec_compCascDcyBrP, Tagrecsd_compCascDcyBrP, Tagrecsf_compCascDcyBrP, Tagrecsi_compCascDcyBrP, Tagreca_compCascDcyBrP, Nrec_compCascDcyBrP, "% Component analysis --- cascade decay branches of particles");
              if(m_vPid_compDcyFStP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP, "% Component analysis --- decay final states of particles");
              if(m_vPid_compProdBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles");
              if(m_vPid_compMP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles");
              if(m_vPid_sigP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles");
              if(m_vSigDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_sigDcyBr, m_vTBrNmOfTagRec_sigDcyBr, m_vTBrNmOfNRec_sigDcyBr, Tagrecsd_sigDcyBr, Tagrecsf_sigDcyBr, Tagrecsi_sigDcyBr, Tagreca_sigDcyBr, Nrec_sigDcyBr, "% Signal identification --- decay branches");
              if(m_vSigIncDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches");
              if(m_vSigCascDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncCascDcyBr, m_vTBrNmOfTagRec_sigIncCascDcyBr, m_vTBrNmOfNRec_sigIncCascDcyBr, Tagrecsd_sigIncCascDcyBr, Tagrecsf_sigIncCascDcyBr, Tagrecsi_sigIncCascDcyBr, Tagreca_sigIncCascDcyBr, Nrec_sigIncCascDcyBr, "% Signal identification --- inclusive cascade decay branches", m_vTypeOfTagRec_sigCascDcyBr, m_vTBrNmOfTagRec_sigCascDcyBr, m_vTBrNmOfNRec_sigCascDcyBr, Tagrecsd_sigCascDcyBr, Tagrecsf_sigCascDcyBr, Tagrecsi_sigCascDcyBr, Tagreca_sigCascDcyBr, Nrec_sigCascDcyBr, "% Signal identification --- cascade decay branches");
            }
            ...
            {
              if(m_vPid_compDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches", m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP, "% Component analysis --- decay branches of particles");
              if(m_vPid_compCascDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches", m_vTypeOfTagRec_compCascDcyBrP, m_vTBrNmOfTagRec_compCascDcyBrP, m_vTBrNmOfNRec_compCascDcyBrP, Tagrecsd_compCascDcyBrP, Tagrecsf_compCascDcyBrP, Tagrecsi_compCascDcyBrP, Tagreca_compCascDcyBrP, Nrec_compCascDcyBrP, "% Component analysis --- cascade decay branches of particles");
              if(m_vPid_compDcyFStP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches", m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP, "% Component analysis --- decay final states of particles");
              if(m_vPid_compProdBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches", m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles");
              if(m_vPid_compMP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches", m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles");
              if(m_vPid_sigP.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches", m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles");
              if(m_vSigDcyBr.size()>0) cpBrVals(m_vTypeOfTagRec_sigIncDcyBr, m_vTBrNmOfTagRec_sigIncDcyBr, m_vTBrNmOfNRec_sigIncDcyBr, Tagrecsd_sigIncDcyBr, Tagrecsf_sigIncDcyBr, Tagrecsi_sigIncDcyBr, Tagreca_sigIncDcyBr, Nrec_sigIncDcyBr, "% Signal identification --- inclusive decay branches", m_vTypeOfTagRec_sigDcyBr, m_vTBrNmOfTagRec_sigDcyBr, m_vTBrNmOfNRec_sigDcyBr, Tagrecsd_sigDcyBr, Tagrecsf_sigDcyBr, Tagrecsi_sigDcyBr, Tagreca_sigDcyBr, Nrec_sigDcyBr, "% Signal identification --- decay branches");
            }
            ...
            {
              if(m_vPid_compDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles", m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP, "% Component analysis --- decay branches of particles");
              if(m_vPid_compCascDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles", m_vTypeOfTagRec_compCascDcyBrP, m_vTBrNmOfTagRec_compCascDcyBrP, m_vTBrNmOfNRec_compCascDcyBrP, Tagrecsd_compCascDcyBrP, Tagrecsf_compCascDcyBrP, Tagrecsi_compCascDcyBrP, Tagreca_compCascDcyBrP, Nrec_compCascDcyBrP, "% Component analysis --- cascade decay branches of particles");
              if(m_vPid_compDcyFStP.size()>0) cpBrVals(m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles", m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP, "% Component analysis --- decay final states of particles");
              if(m_vPid_compProdBrP.size()>0) cpBrVals(m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles", m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles");
              if(m_vPid_compMP.size()>0) cpBrVals(m_vTypeOfTagRec_sigP, m_vTBrNmOfTagRec_sigP, m_vTBrNmOfNRec_sigP, Tagrecsd_sigP, Tagrecsf_sigP, Tagrecsi_sigP, Tagreca_sigP, Nrec_sigP, "% Signal identification --- paticles", m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles");
            }
          else if(m_vPid_compMP.size()>0)
            {
              if(m_vPid_compDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles", m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP, "% Component analysis --- decay branches of particles");
              if(m_vPid_compCascDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles", m_vTypeOfTagRec_compCascDcyBrP, m_vTBrNmOfTagRec_compCascDcyBrP, m_vTBrNmOfNRec_compCascDcyBrP, Tagrecsd_compCascDcyBrP, Tagrecsf_compCascDcyBrP, Tagrecsi_compCascDcyBrP, Tagreca_compCascDcyBrP, Nrec_compCascDcyBrP, "% Component analysis --- cascade decay branches of particles");
              if(m_vPid_compDcyFStP.size()>0) cpBrVals(m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles", m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP, "% Component analysis --- decay final states of particles");
              if(m_vPid_compProdBrP.size()>0) cpBrVals(m_vTypeOfTagRec_compMP, m_vTBrNmOfTagRec_compMP, m_vTBrNmOfNRec_compMP, Tagrecsd_compMP, Tagrecsf_compMP, Tagrecsi_compMP, Tagreca_compMP, Nrec_compMP, "% Component analysis --- mothers of particles", m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles");
            }
          else if(m_vPid_compProdBrP.size()>0)
            {
              if(m_vPid_compDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles", m_vTypeOfTagRec_compDcyBrP, m_vTBrNmOfTagRec_compDcyBrP, m_vTBrNmOfNRec_compDcyBrP, Tagrecsd_compDcyBrP, Tagrecsf_compDcyBrP, Tagrecsi_compDcyBrP, Tagreca_compDcyBrP, Nrec_compDcyBrP, "% Component analysis --- decay branches of particles");
              if(m_vPid_compCascDcyBrP.size()>0) cpBrVals(m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles", m_vTypeOfTagRec_compCascDcyBrP, m_vTBrNmOfTagRec_compCascDcyBrP, m_vTBrNmOfNRec_compCascDcyBrP, Tagrecsd_compCascDcyBrP, Tagrecsf_compCascDcyBrP, Tagrecsi_compCascDcyBrP, Tagreca_compCascDcyBrP, Nrec_compCascDcyBrP, "% Component analysis --- cascade decay branches of particles");
              if(m_vPid_compDcyFStP.size()>0) cpBrVals(m_vTypeOfTagRec_compProdBrP, m_vTBrNmOfTagRec_compProdBrP, m_vTBrNmOfNRec_compProdBrP, Tagrecsd_compProdBrP, Tagrecsf_compProdBrP, Tagrecsi_compProdBrP, Tagreca_compProdBrP, Nrec_compProdBrP, "% Component analysis --- production branches of particles", m_vTypeOfTagRec_compDcyFStP, m_vTBrNmOfTagRec_compDcyFStP, m_vTBrNmOfNRec_compDcyFStP, Tagrecsd_compDcyFStP, Tagrecsf_compDcyFStP, Tagrecsi_compDcyFStP, Tagreca_compDcyFStP, Nrec_compDcyFStP, "% Component analysis --- decay final states of particles");
            }
          ...
          if(m_strgTpOfRawIptTopoDat=="MSF"||m_strgTpOfRawIptTopoDat=="MSD")
            {
              for(unsigned int j=0;j<m_vPid_compDcyBrP.size();j++)
                if(m_vTypeOfTagRec_compDcyBrP[j]=="c"||m_vTypeOfTagRec_compDcyBrP[j]=="n"||m_vTypeOfTagRec_compDcyBrP[j]=="!n"||m_vTypeOfTagRec_compDcyBrP[j]=="p"||m_vTypeOfTagRec_compDcyBrP[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_compDcyBrP[j]=Tagrecsf_compDcyBrP[j];
                    else Tagrecsi_compDcyBrP[j]=Tagrecsd_compDcyBrP[j];
                  }

              for(unsigned int j=0;j<m_vPid_compCascDcyBrP.size();j++)
                if(m_vTypeOfTagRec_compCascDcyBrP[j]=="c"||m_vTypeOfTagRec_compCascDcyBrP[j]=="n"||m_vTypeOfTagRec_compCascDcyBrP[j]=="!n"||m_vTypeOfTagRec_compCascDcyBrP[j]=="p"||m_vTypeOfTagRec_compCascDcyBrP[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_compCascDcyBrP[j]=Tagrecsf_compCascDcyBrP[j];
                    else Tagrecsi_compCascDcyBrP[j]=Tagrecsd_compCascDcyBrP[j];
                  }

              for(unsigned int j=0;j<m_vPid_compDcyFStP.size();j++)
                if(m_vTypeOfTagRec_compDcyFStP[j]=="c"||m_vTypeOfTagRec_compDcyFStP[j]=="n"||m_vTypeOfTagRec_compDcyFStP[j]=="!n"||m_vTypeOfTagRec_compDcyFStP[j]=="p"||m_vTypeOfTagRec_compDcyFStP[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_compDcyFStP[j]=Tagrecsf_compDcyFStP[j];
                    else Tagrecsi_compDcyFStP[j]=Tagrecsd_compDcyFStP[j];
                  }

              for(unsigned int j=0;j<m_vPid_compProdBrP.size();j++)
                if(m_vTypeOfTagRec_compProdBrP[j]=="c"||m_vTypeOfTagRec_compProdBrP[j]=="n"||m_vTypeOfTagRec_compProdBrP[j]=="!n"||m_vTypeOfTagRec_compProdBrP[j]=="p"||m_vTypeOfTagRec_compProdBrP[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_compProdBrP[j]=Tagrecsf_compProdBrP[j];
                    else Tagrecsi_compProdBrP[j]=Tagrecsd_compProdBrP[j];
                  }

              for(unsigned int j=0;j<m_vPid_compMP.size();j++)
                if(m_vTypeOfTagRec_compMP[j]=="c"||m_vTypeOfTagRec_compMP[j]=="n"||m_vTypeOfTagRec_compMP[j]=="!n"||m_vTypeOfTagRec_compMP[j]=="p"||m_vTypeOfTagRec_compMP[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_compMP[j]=Tagrecsf_compMP[j];
                    else Tagrecsi_compMP[j]=Tagrecsd_compMP[j];
                  }

              for(unsigned int j=0;j<m_vPid_sigP.size();j++)
                if(m_vTypeOfTagRec_sigP[j]=="c"||m_vTypeOfTagRec_sigP[j]=="n"||m_vTypeOfTagRec_sigP[j]=="!n"||m_vTypeOfTagRec_sigP[j]=="p"||m_vTypeOfTagRec_sigP[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_sigP[j]=Tagrecsf_sigP[j];
                    else Tagrecsi_sigP[j]=Tagrecsd_sigP[j];
                  }

              for(unsigned int j=0;j<m_vSigDcyBr.size();j++)
                if(m_vTypeOfTagRec_sigDcyBr[j]=="c"||m_vTypeOfTagRec_sigDcyBr[j]=="n"||m_vTypeOfTagRec_sigDcyBr[j]=="!n"||m_vTypeOfTagRec_sigDcyBr[j]=="p"||m_vTypeOfTagRec_sigDcyBr[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_sigDcyBr[j]=Tagrecsf_sigDcyBr[j];
                    else Tagrecsi_sigDcyBr[j]=Tagrecsd_sigDcyBr[j];
                  }

              for(unsigned int j=0;j<m_vSigIncDcyBr.size();j++)
                if(m_vTypeOfTagRec_sigIncDcyBr[j]=="c"||m_vTypeOfTagRec_sigIncDcyBr[j]=="n"||m_vTypeOfTagRec_sigIncDcyBr[j]=="!n"||m_vTypeOfTagRec_sigIncDcyBr[j]=="p"||m_vTypeOfTagRec_sigIncDcyBr[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_sigIncDcyBr[j]=Tagrecsf_sigIncDcyBr[j];
                    else Tagrecsi_sigIncDcyBr[j]=Tagrecsd_sigIncDcyBr[j];
                  }

              for(unsigned int j=0;j<m_vSigCascDcyBr.size();j++)
                if(m_vTypeOfTagRec_sigCascDcyBr[j]=="c"||m_vTypeOfTagRec_sigCascDcyBr[j]=="n"||m_vTypeOfTagRec_sigCascDcyBr[j]=="!n"||m_vTypeOfTagRec_sigCascDcyBr[j]=="p"||m_vTypeOfTagRec_sigCascDcyBr[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_sigCascDcyBr[j]=Tagrecsf_sigCascDcyBr[j];
                    else Tagrecsi_sigCascDcyBr[j]=Tagrecsd_sigCascDcyBr[j];
                  }

              for(unsigned int j=0;j<m_vSigIncCascDcyBr.size();j++)
                if(m_vTypeOfTagRec_sigIncCascDcyBr[j]=="c"||m_vTypeOfTagRec_sigIncCascDcyBr[j]=="n"||m_vTypeOfTagRec_sigIncCascDcyBr[j]=="!n"||m_vTypeOfTagRec_sigIncCascDcyBr[j]=="p"||m_vTypeOfTagRec_sigIncCascDcyBr[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_sigIncCascDcyBr[j]=Tagrecsf_sigIncCascDcyBr[j];
                    else Tagrecsi_sigIncCascDcyBr[j]=Tagrecsd_sigIncCascDcyBr[j];
                  }

              for(unsigned int j=0;j<m_vSigIRADcyBr.size();j++)
                if(m_vTypeOfTagRec_sigIRADcyBr[j]=="c"||m_vTypeOfTagRec_sigIRADcyBr[j]=="n"||m_vTypeOfTagRec_sigIRADcyBr[j]=="!n"||m_vTypeOfTagRec_sigIRADcyBr[j]=="p"||m_vTypeOfTagRec_sigIRADcyBr[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_sigIRADcyBr[j]=Tagrecsf_sigIRADcyBr[j];
                    else Tagrecsi_sigIRADcyBr[j]=Tagrecsd_sigIRADcyBr[j];
                  }

              for(unsigned int j=0;j<m_vSigIncOrIRACascDcyBr.size();j++)
                if(m_vTypeOfTagRec_sigIncOrIRACascDcyBr[j]=="c"||m_vTypeOfTagRec_sigIncOrIRACascDcyBr[j]=="n"||m_vTypeOfTagRec_sigIncOrIRACascDcyBr[j]=="!n"||m_vTypeOfTagRec_sigIncOrIRACascDcyBr[j]=="p"||m_vTypeOfTagRec_sigIncOrIRACascDcyBr[j]=="i")
                  {
                    if(m_strgTpOfRawIptTopoDat=="MSF") Tagrecsi_sigIncOrIRACascDcyBr[j]=Tagrecsf_sigIncOrIRACascDcyBr[j];
                    else Tagrecsi_sigIncOrIRACascDcyBr[j]=Tagrecsd_sigIncOrIRACascDcyBr[j];
                  }
            }
          ...
          if(m_vSigDcyBr.size()>0)
            {
              for(unsigned int j=0;j<m_vSigDcyBr.size();j++)
                {
                  nSigDcyBr[j]=0;
                  for(unsigned int k=0;k<dcyTr.size();k++)
                     {
                       if(m_vTypeOfTagRec_sigDcyBr[j]!="")
                         {
                           if(m_vTypeOfTagRec_sigDcyBr[j]!="i"&&m_vTypeOfTagRec_sigDcyBr[j]!="I") _isTagMatched=isTagMatched(m_vTypeOfTagRec_sigDcyBr[j], Tagrecsi_sigDcyBr[j], Tagreca_sigDcyBr[j], Nrec_sigDcyBr[j], (*m_vSigDcyBr[j].begin()));
                           else _isTagMatched=isTagMatched(m_vTypeOfTagRec_sigDcyBr[j], Tagrecsi_sigDcyBr[j], Tagreca_sigDcyBr[j], Nrec_sigDcyBr[j], Ridx[vIdxOrg[vIdxOfHead[k]]]);
                           if(_isTagMatched==false) continue;
                         }
                       if(dcyTr[k]==m_vSigDcyBr[j]) nSigDcyBr[j]++;
                     }
                      ...
                      for(unsigned int k=0;k<dcyTr.size();k++)
                        {
                          if(m_vTypeOfTagRec_sigDcyBr[j]!="")
                            {
                              if(m_vTypeOfTagRec_sigDcyBr[j]!="i"&&m_vTypeOfTagRec_sigDcyBr[j]!="I") _isTagMatched=isTagMatched(m_vTypeOfTagRec_sigDcyBr[j], Tagrecsi_sigDcyBr[j], Tagreca_sigDcyBr[j], Nrec_sigDcyBr[j], (*m_vCcSigDcyBr[j].begin()));
                              else _isTagMatched=isTagMatched(m_vTypeOfTagRec_sigDcyBr[j], Tagrecsi_sigDcyBr[j], Tagreca_sigDcyBr[j], Nrec_sigDcyBr[j], Ridx[vIdxOrg[vIdxOfHead[k]]]);
                              if(_isTagMatched==false) continue;
                            }
                          if(dcyTr[k]==m_vCcSigDcyBr[j]) nCcSigDcyBr[j]++;
                        }
