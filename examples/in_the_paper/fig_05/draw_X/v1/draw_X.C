void draw_X()
{
  ...
  chain->Add("../../../ex_for_tb_01/jpsi_ta.root");
  ...
  "J/#psi #rightarrow #pi^{0} 2#pi^{+} 2#pi^{-}",
  "J/#psi #rightarrow #pi^{0} 3#pi^{+} 3#pi^{-}",
  "J/#psi #rightarrow #pi^{0} #pi^{+} #pi^{-} K^{+} K^{-}",
  "J/#psi #rightarrow #rho^{+} #rho^{-} #omega, ...",
  "J/#psi #rightarrow e^{+} e^{-} #gamma^{f}",
  "J/#psi #rightarrow 2#pi^{0} 2#pi^{+} 2#pi^{-}",
  "J/#psi #rightarrow #pi^{0} 4#pi^{+} 4#pi^{-}",
  "J/#psi #rightarrow #pi^{0} #pi^{+} #pi^{-} #gamma^{F}"
  };
