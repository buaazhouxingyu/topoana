...
$ \\ ($
\Upsilon(4S) \dashrightarrow B^{0} \bar{B}^{0} 
$) } & \topoTags{0 & }81057 & 81057 \EOL

% \rn = 2
\rn & \makecell[l]{ $ 
\Upsilon(4S) \rightarrow B^{0} B^{0} 
$ \\ ($
\Upsilon(4S) \dashrightarrow B^{0} B^{0} 
$) } & \topoTags{1 & }9487 & 90544 \EOL

% \rn = 3
\rn & \makecell[l]{ $ 
\Upsilon(4S) \rightarrow \bar{B}^{0} \bar{B}^{0} 
$ \\ ($
\Upsilon(4S) \dashrightarrow \bar{B}^{0} \bar{B}^{0} 
$) } & \topoTags{2 & }9456 & 100000 \\ \hline
