...
An essential description of the program is in the document: ``share/paper_draft_v2.5.1.pdf``
(**Please note that all the examples in the paper draft can be found in the sub-directory ``examples/in_the_paper``**)

A detailed description of the program is in the document: ``share/user_guide_v4.5.1.pdf``
