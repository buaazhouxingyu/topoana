  ...
  if(m_anaTasksForSigIds=="TC")
    {
      ...
      cout<<"2. Tags of topology are inserted in all the entries of the TTree \""<<m_ttrNm<<"\" of the output root file (files): "<<NmOfOptRootFl1st<<"(and "<<NmOfOptRootFlRest<<" if any)"<<". Except for this, the TTree \""<<m_ttrNm<<"\" of The output root file is entirely the same as that (those) of the input root file (files). Besides, the topology tags are identical with those listed in the txt/tex/pdf files."<<endl;
    }
