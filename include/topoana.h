...
class topoana
{
  ...
  public:
    topoana()
    {
      m_pkgPath="/workfs/bes/zhouxy/topoana-02-11-03/";
      m_verNum="v2.11.3";
    ...
    void           cpBrVals2(vector<string> vTypeOfTagRec, vector<string> vTBrNmOfTagRec, int * Nrec, int Tagreca[][20], int * Tagrecsi, float * Tagrecsf, double * Tagrecsd);
    ...
    string	   cutToSelect(string strDcyBr, string aliasMP, string ccType="all", int nTBrs=1, int nCcTBrs=1, string topoType="dcyBr", string lang="python");
};
