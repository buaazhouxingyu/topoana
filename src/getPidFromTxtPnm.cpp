...
int topoana::getPidFromTxtPnm(string pnm)
{
  ...
  if(inTheMap)
  ...
  else
    {
      ...
      cerr<<"Infor: 1) Please refer to the pdl file \""<<evtPdlFlNm<<"\" related to your BOSS, BASF, or BASF2 release release, find the PDG code and 3 times charge of the particle."<<endl;
      ...
      cerr<<"Infor: Please contact me (zhouxy@lnnu.edu.cn), if you still have questions about the problem."<<endl<<endl;
      exit(-1);
    }
}
