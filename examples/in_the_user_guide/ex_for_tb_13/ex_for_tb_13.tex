...
\tablecaption{Signal decay initial-final states.}
\tableheaderP{rowNo & \thead{signal decay initial-final states} & \topoTags{iSigDcyIFSts & }nEtr & nCEtr \\}

% \rn = 1
\rn & $ \Upsilon(4S) \dashrightarrow \mu^{+} \nu_{\mu} \pi^{0} \pi^{0} \pi^{0} \pi^{+} \pi^{+} \pi^{+} \pi^{-} \pi^{-} \pi^{-} \pi^{-} K^{+} K^{-} $ & \topoTags{0 & }18 & 18 \EOL

% \rn = 2
\rn & $ \Upsilon(4S) \dashrightarrow \pi^{0} \pi^{0} \pi^{0} \pi^{0} \pi^{0} \pi^{+} \pi^{+} \pi^{+} \pi^{+} \pi^{+} \pi^{-} \pi^{-} \pi^{-} \pi^{-} \pi^{-} K^{+} K^{-} $ & \topoTags{1 & }18 & 36 \\ \hline
